...
const Hero = () => {
  return (
    <section id="home" className="padding relative z-10">
      ...
      >
        <div>
          <motion.h1 variants={textVariant(0.3)} className="h1">
            Let’s Explore Three-Dimensional visual
          </motion.h1>

          <motion.p variants={textVariant(0.4)} className="p mt-5">
          ...
          >
            ...
            <p className="font-semibold text-sm sm:text-base">
              {peopleOnline.total} people online
            </p>
          </motion.div>
        </div>
        ...
        <div className="mt-7 md:mt-5 lg:mt-0 w-full relative flexCenter flex-col">
          ...
          >
            <Image
              ...
              width={72}
              height={72}
              sizes="(min-width: 768px) 72px,
                (min-width: 480px) 65px, 57px"
              className="w-[57px] h-[57px] xs:w-[65px]
                xs:h-[65px] md:w-[72px] md:h-[72px] object-contain"
            />
          </motion.div>
